...
public class GerenciadorConceitosTest {
	...
	public void inicializaGerenciador() {
		...
		this.gc = new GerenciadorConceitosImpl(); // Inicializa o gerenciador
	...
	public void testGerenciador2_36_7() {
		...
		Assert
				.assertFalse(this.gc.adicionaConceito(MAIOR_IGUAL, 0, null,
						null));
		...
		Assert
				.assertFalse(this.gc.adicionaConceito(MAIOR_IGUAL, 7, null,
						null));
		Assert
				.assertFalse(this.gc.adicionaConceito(MAIOR_IGUAL, 7, null,
						null));
	...
	public void testGerenciador8_9_10() {
		...
		Assert.assertFalse(this.gc.adicionaConceito(MENOR, 9, null, null));
		Assert
				.assertFalse(this.gc.adicionaConceito(MENOR, 10, MAIOR_IGUAL,
						1D));

		Assert.assertTrue(this.gc.adicionaConceito(MAIOR, 8, MENOR_IGUAL, 9D));

		Assert.assertFalse(this.gc.adicionaConceito(MAIOR_IGUAL, 9,
				MENOR_IGUAL, 9D));
		Assert.assertFalse(this.gc.adicionaConceito(MAIOR_IGUAL, 3, MENOR, 7D));
		Assert.assertFalse(this.gc.adicionaConceito(MAIOR_IGUAL, 1, MENOR, 7D));
		Assert
		...
		Assert
				.assertTrue(this.gc.adicionaConceito(MAIOR, 9, MENOR_IGUAL,
						10.0));
	...
	public void testGerenciador81_91_10() {
		...
		Assert.assertTrue(this.gc.adicionaConceito(MAIOR_IGUAL, 8.1, MENOR,
				9.1D));
		...
		Assert.assertTrue(this.gc.adicionaConceito(MAIOR_IGUAL, 9.1,
				MENOR_IGUAL, 10.0));
	...
	public void testGerenciador38_58_35() {
		...
		Assert
				.assertTrue(this.gc.adicionaConceito(MAIOR, 5.0, MENOR_IGUAL,
						8D));
		...
		Assert.assertTrue(this.gc.adicionaConceito(MAIOR_IGUAL, 3, MENOR_IGUAL,
				5.0));
	...
	public void testGerenciador8_38_3() {
		...
		Assert
				.assertTrue(this.gc.adicionaConceito(MAIOR_IGUAL, 3.0, MENOR,
						8D));
	...
	public void testGerenciador3_3_3() {
		...
		Assert.assertTrue(this.gc.adicionaConceito(MAIOR_IGUAL, 3.0,
				MENOR_IGUAL, 3D));

		Assert.assertFalse(this.gc.adicionaConceito(MAIOR_IGUAL, 3.0,
				MENOR_IGUAL, 3D));
